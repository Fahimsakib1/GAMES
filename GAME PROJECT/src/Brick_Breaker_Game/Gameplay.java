...

{
    ...
    @Override
	public void keyTyped(KeyEvent e)  // don't delete this. It it show  an error to the Gameplay Class
	{
	...
	@Override
	public void keyReleased(KeyEvent e)  // don't delete this. It it show  an error to the Gameplay Class
	{
